...
import style from './RenderWithMap';

const data = [
    {
        "maPhim": 1321,
        "tenPhim": "Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 Ted2 ",
        "biDanh": "ted2",
...
export default class BaiTapRenderDanhSachPhim extends Component {
    ...
    renderPhim = () => {
        return data.map(item => {
            return <div className="col-4 mb-2" key={item.maPhim}>
                <div className="card">
                    <img src={item.hinhAnh} className="card-img-top" alt="Film" style={{
                    height: '200px',
                    width: 'auto'
                }} />
                    <div className="card-body" style={{
                        ...
                        <h5 className="card-title" style={{
                            height: '50px'
                        }}>{item.tenPhim.length > 50 ? item.tenPhim.substr(0, 50)+"..." : item.tenPhim}</h5>
                        <p className="card-text">{item.moTa.length > 150 ? item.moTa.substr(0, 150)+"..." : item.moTa }</p>
                    </div>
                </div>
            </div>
        });
